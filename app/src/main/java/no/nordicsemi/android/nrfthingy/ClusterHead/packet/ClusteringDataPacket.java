...
public class ClusteringDataPacket extends BaseDataPacket {
    ...
    public static final int ELEMENT_ADDRESS_SIZE = "00:11:22:AA:BB:CC".getBytes().length; //  Bluetooth addresses look like this: "00:11:22:AA:BB:CC" and chars need 2 bytes.
    ...
    private byte[] leafToBytes(ClusterLeaf leaf) {
        ...
        byte[] addressBytes = leaf.getAddress().getBytes();
